...
type (
	...
	GetConversationReq          = im.GetConversationReq
	GetConversationResp         = im.GetConversationResp
	PutConversationReq          = im.PutConversationReq
	PutConversationResp         = im.PutConversationResp
...
// 获取会话
func (m *defaultIm) GetConversations(ctx context.Context, in *GetConversationReq, opts ...grpc.CallOption) (*GetConversationResp, error) {
	client := im.NewImClient(m.cli.Conn())
	return client.GetConversations(ctx, in, opts...)
}

// 更新会话
func (m *defaultIm) PutConversations(ctx context.Context, in *PutConversationReq, opts ...grpc.CallOption) (*PutConversationResp, error) {
	client := im.NewImClient(m.cli.Conn())
