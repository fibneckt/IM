...
func (x *GetConversationResp) GetConversationList() map[string]*Conversation {
	if x != nil {
...
type PutConversationReq struct {
	state            protoimpl.MessageState   `protogen:"open.v1"`
	Id               string                   `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
...
func (x *PutConversationReq) Reset() {
	*x = PutConversationReq{}
	mi := &file_apps_im_rpc_im_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PutConversationReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PutConversationReq) ProtoMessage() {}

func (x *PutConversationReq) ProtoReflect() protoreflect.Message {
	mi := &file_apps_im_rpc_im_proto_msgTypes[4]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PutConversationReq.ProtoReflect.Descriptor instead.
func (*PutConversationReq) Descriptor() ([]byte, []int) {
	return file_apps_im_rpc_im_proto_rawDescGZIP(), []int{4}
}

func (x *PutConversationReq) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *PutConversationReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *PutConversationReq) GetConversationList() map[string]*Conversation {
	if x != nil {
		return x.ConversationList
	}
	return nil
...
type PutConversationResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *PutConversationResp) Reset() {
	*x = PutConversationResp{}
	mi := &file_apps_im_rpc_im_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *PutConversationResp) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PutConversationResp) ProtoMessage() {}

func (x *PutConversationResp) ProtoReflect() protoreflect.Message {
	mi := &file_apps_im_rpc_im_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PutConversationResp.ProtoReflect.Descriptor instead.
func (*PutConversationResp) Descriptor() ([]byte, []int) {
...
type CreateGroupConversationReq struct {
	...
	CreatedId     string                 `protobuf:"bytes,2,opt,name=CreatedId,proto3" json:"CreatedId,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateGroupConversationReq) GetCreatedId() string {
	if x != nil {
		return x.CreatedId
	}
	return ""
...
const file_apps_im_rpc_im_proto_rawDesc = "" +
	...
	"\x12GetConversationReq\x12\x16\n" +
	"\x06userId\x18\x01 \x01(\tR\x06userId\"\xc7\x01\n" +
	"\x13GetConversationResp\x12Y\n" +
	"\x10conversationList\x18\x02 \x03(\v2-.im.GetConversationResp.ConversationListEntryR\x10conversationList\x1aU\n" +
	"\x15ConversationListEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12&\n" +
	"\x05value\x18\x02 \x01(\v2\x10.im.ConversationR\x05value:\x028\x01\"\xed\x01\n" +
	"\x12PutConversationReq\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06userId\x18\x02 \x01(\tR\x06userId\x12X\n" +
	"\x10conversationList\x18\x03 \x03(\v2,.im.PutConversationReq.ConversationListEntryR\x10conversationList\x1aU\n" +
	"\x15ConversationListEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12&\n" +
	"\x05value\x18\x02 \x01(\v2\x10.im.ConversationR\x05value:\x028\x01\"\x15\n" +
	"\x13PutConversationResp\"\xab\x01\n" +
	"\rGetChatLogReq\x12&\n" +
	...
	"\tCreatedId\x18\x02 \x01(\tR\tCreatedId\"\x1d\n" +
	"\x1bCreateGroupConversationResp2\xf5\x02\n" +
	"\x02Im\x123\n" +
	"\n" +
	"GetChatLog\x12\x11.im.GetChatLogReq\x1a\x12.im.GetChatLogResp\x12T\n" +
	"\x15SetUpUserConversation\x12\x1c.im.SetUpUserConversationReq\x1a\x1d.im.SetUpUserConversationResp\x12C\n" +
	"\x10GetConversations\x12\x16.im.GetConversationReq\x1a\x17.im.GetConversationResp\x12C\n" +
	"\x10PutConversations\x12\x16.im.PutConversationReq\x1a\x17.im.PutConversationResp\x12Z\n" +
...
var file_apps_im_rpc_im_proto_goTypes = []any{
	...
	(*GetConversationReq)(nil),          // 2: im.GetConversationReq
	(*GetConversationResp)(nil),         // 3: im.GetConversationResp
	(*PutConversationReq)(nil),          // 4: im.PutConversationReq
	(*PutConversationResp)(nil),         // 5: im.PutConversationResp
	...
	nil,                                 // 12: im.GetConversationResp.ConversationListEntry
	nil,                                 // 13: im.PutConversationReq.ConversationListEntry
}
var file_apps_im_rpc_im_proto_depIdxs = []int32{
	0,  // 0: im.Conversation.msg:type_name -> im.ChatLog
	12, // 1: im.GetConversationResp.conversationList:type_name -> im.GetConversationResp.ConversationListEntry
	13, // 2: im.PutConversationReq.conversationList:type_name -> im.PutConversationReq.ConversationListEntry
	0,  // 3: im.GetChatLogResp.List:type_name -> im.ChatLog
	1,  // 4: im.GetConversationResp.ConversationListEntry.value:type_name -> im.Conversation
	1,  // 5: im.PutConversationReq.ConversationListEntry.value:type_name -> im.Conversation
	6,  // 6: im.Im.GetChatLog:input_type -> im.GetChatLogReq
	8,  // 7: im.Im.SetUpUserConversation:input_type -> im.SetUpUserConversationReq
	2,  // 8: im.Im.GetConversations:input_type -> im.GetConversationReq
	4,  // 9: im.Im.PutConversations:input_type -> im.PutConversationReq
	...
	3,  // 13: im.Im.GetConversations:output_type -> im.GetConversationResp
	5,  // 14: im.Im.PutConversations:output_type -> im.PutConversationResp
