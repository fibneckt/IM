...
type ImClient interface {
	...
	// 获取会话
	GetConversations(ctx context.Context, in *GetConversationReq, opts ...grpc.CallOption) (*GetConversationResp, error)
	// 更新会话
	PutConversations(ctx context.Context, in *PutConversationReq, opts ...grpc.CallOption) (*PutConversationResp, error)
	// 创建群聊会话
...
func (c *imClient) GetConversations(ctx context.Context, in *GetConversationReq, opts ...grpc.CallOption) (*GetConversationResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *imClient) PutConversations(ctx context.Context, in *PutConversationReq, opts ...grpc.CallOption) (*PutConversationResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PutConversationResp)
...
type ImServer interface {
	...
	// 获取会话
	GetConversations(context.Context, *GetConversationReq) (*GetConversationResp, error)
	// 更新会话
	PutConversations(context.Context, *PutConversationReq) (*PutConversationResp, error)
	// 创建群聊会话
...
func (UnimplementedImServer) GetConversations(context.Context, *GetConversationReq) (*GetConversationResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetConversations not implemented")
}
func (UnimplementedImServer) PutConversations(context.Context, *PutConversationReq) (*PutConversationResp, error) {
...
func _Im_GetConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImServer).GetConversations(ctx, req.(*GetConversationReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Im_PutConversations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ImServer).PutConversations(ctx, req.(*PutConversationReq))
	}
	return interceptor(ctx, in, info, handler)
}
