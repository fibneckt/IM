...
// 获取会话
func (s *ImServer) GetConversations(ctx context.Context, in *im.GetConversationReq) (*im.GetConversationResp, error) {
	l := logic.NewGetConversationsLogic(ctx, s.svcCtx)
	return l.GetConversations(in)
}

// 更新会话
func (s *ImServer) PutConversations(ctx context.Context, in *im.PutConversationReq) (*im.PutConversationResp, error) {
