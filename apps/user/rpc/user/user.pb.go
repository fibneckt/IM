...
type UserEntity struct {
	...
	Phone         string                 `protobuf:"bytes,4,opt,name=phone,proto3" json:"phone,omitempty"`       // 手机好吗
	Status        string                 `protobuf:"bytes,5,opt,name=status,proto3" json:"status,omitempty"`     // 是否锁住
...
const file_apps_user_rpc_user_proto_rawDesc = "" +
	"\n" +
	"\x18apps/user/rpc/user.proto\"\x90\x01\n" +
	"\n" +
	"UserEntity\x12\x0e\n" +
	...
	"\x04user\x18\x01 \x01(\v2\v.UserEntityR\x04user\"I\n" +
	"\vFindUserReq\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x14\n" +
	"\x05phone\x18\x02 \x01(\tR\x05phone\x12\x10\n" +
	"\x03ids\x18\x03 \x03(\tR\x03ids\"/\n" +
	"\fFindUserResp\x12\x1f\n" +
	"\x04user\x18\x01 \x03(\v2\v.UserEntityR\x04user2\xc7\x01\n" +
	"\x04User\x12\x1b\n" +
	"\x04Ping\x12\b.Request\x1a\t.Response\x12\x1e\n" +
	"\x05Login\x12\t.LoginReq\x1a\n" +
	".LoginResp\x12'\n" +
	"\bRegister\x12\f.RegisterReq\x1a\r.RegisterResp\x120\n" +
	"\vGetUserInfo\x12\x0f.GetUserInfoReq\x1a\x10.GetUserInfoResp\x12'\n" +
	"\bFindUser\x12\f.FindUserReq\x1a\r.FindUserRespB\bZ\x06./userb\x06proto3"
